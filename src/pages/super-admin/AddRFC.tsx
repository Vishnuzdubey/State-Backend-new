...
export function AddRFC() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await superAdminApi.createRFC(form);

      toast({
        title: 'Success',
        description: response.message || 'RFC created successfully',
      });

      navigate('/super-admin/rfcs');
    } catch (error) {
      const errorMessage = error instanceof Error ? error.message : 'Failed to create RFC';
